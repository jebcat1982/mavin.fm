...
albums << {"http://supergiantgames.bandcamp.com/album/bastion-original-soundtrack" => "acoustic frontier triphop,bastion,soundtrack,supergiant,videogame,San Jose,triphop"}
albums << {"http://theukeladies.bandcamp.com/album/the-ukeladies" => "dreamscape,faux,hawaiian,future,retro,tropical,Melbourne"}
albums << {"http://pickwick.bandcamp.com/album/myths-vol-1" => "r&b,alternative,pop,rock,soul,Seattle"}
albums << {"http://woodspider.bandcamp.com/album/in-the-thick-of-it" => "diy folk, folk punk, roots, vaudeville, accordion, acoustic, banjo, birthquake records, cello, freak folk, free download, lo-fi, new england gothic, ukuleler,New York"}
...
albums << {"http://thewillowandthebuilder.bandcamp.com/album/the-willow-the-builder" => "adrian simon, folk, middletown, new haven, richard miron, the willow and the builder, wesleyan, yale, folk, indie, rock, Connecticut"}
